...
namespace recis {
namespace optim {
struct SparseAdamWOptions
    : public SparseOptimizerCloneableOptions<SparseAdamWOptions> {
  SparseAdamWOptions(double lr = 1e-3);
...
struct TORCH_API SparseAdamWParamState
    : public SparseOptimizerCloneableParamState<SparseAdamWParamState> {
 public:
  SparseAdamWParamState()
  ...
  TORCH_API friend bool operator==(const SparseAdamWParamState &lhs,
                                   const SparseAdamWParamState &rhs);
...
class SparseAdamW : public SparseOptimizer {
 public:
  explicit SparseAdamW(std::vector<SparseOptimizerParamGroup> param_groups,
                       SparseAdamWOptions defaults = {})
      : SparseOptimizer(std::move(param_groups),
                        std::make_unique<SparseAdamWOptions>(defaults)) {
  ...
  explicit SparseAdamW(std::unordered_map<std::string, HashTablePtr> params,
                       SparseAdamWOptions defaults = {})
      : SparseAdamW({SparseOptimizerParamGroup(std::move(params))}, defaults) {}
